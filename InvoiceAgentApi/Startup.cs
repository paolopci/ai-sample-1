...
{
    public static void ConfigureServices(Microsoft.AspNetCore.Builder.WebApplicationBuilder builder, string provider, string model)
    {
        ...
        builder.Services.AddSingleton<DocumentationClient>();
